...
import { Shield, BookOpen, Award, AlertTriangle, Terminal } from 'lucide-react';
      ...
      <main className="flex-grow max-w-7xl mx-auto w-full px-6 py-12 md:py-24 flex flex-col justify-center gap-16">
        ...
        <section className="text-center max-w-3xl mx-auto flex flex-col items-center gap-6">
          ...
          <div className="mt-4 flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a 
              href="#labs" 
              className="text-sm font-semibold text-[#9CA3AF] hover:text-[#F3F4F6] transition-colors py-2 px-4"
            >
              Explore Labs &rarr;
            </a>
          </div>
